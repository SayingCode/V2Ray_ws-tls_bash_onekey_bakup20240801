...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/SayingCode/V2Ray_ws-tls_bash_onekey_bakup20240801/refs/heads/master/install.sh" && chmod +x install.sh && bash install.sh
```
